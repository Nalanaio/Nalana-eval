"""v2.0 schema — copied verbatim from Nalana-eval/schema.py; do NOT modify fields.

Legacy fixtures use fixture_version="2.0". Tests that load v2.0 cases should
import from this module. No v3.0 fields are added here.
"""
